      ...
      <div className="relative h-56 bg-gradient-to-br from-red-100 to-orange-100 overflow-hidden">
        ...
        {popular && (
          <motion.span
            ...
            className="absolute top-4 right-4 bg-gradient-to-r from-red-600 to-orange-600 text-white text-sm px-4 py-1.5 rounded-full font-bold shadow-lg"
          >
            Popular
          </motion.span>
        )}
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onAddToCart}
          className="absolute bottom-4 left-4 right-4 bg-white text-red-600 py-3 rounded-xl font-bold opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-lg hover:bg-red-600 hover:text-white flex items-center justify-center gap-2"
        >
