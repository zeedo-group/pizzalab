              ...
              <div className="flex gap-4">
                {["Facebook", "Instagram", "Twitter"].map((social) => (
                  <motion.a
                    ...
                    className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-gradient-to-r hover:from-red-600 hover:to-orange-600 transition-all text-sm font-medium"
                  >
                    {social[0]}
                  </motion.a>
                ))}
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.href}>
                    ...
                    >
                      <span className="w-1 h-1 bg-red-500 rounded-full group-hover:w-2 group-hover:h-2 transition-all" />
                      {link.label}
                    </Link>
                  </li>
                ))}
